...
mod cat_stage_manager {
    #[cfg(feature = "scrap")] pub(crate) mod chain;
    #[cfg(feature = "scrap")] pub(crate) mod constructor;
    #[cfg(feature = "scrap")] pub(crate) mod octopurr;
    #[cfg(feature = "scrap")] pub(crate) mod pounce_drop;
...
#[cfg(feature = "train")]
#[proc_macro_derive(PurrRule)]
pub fn derive_purr_rule(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    cat_malloc::purr_train::derive_purr_rule_impl(input)
}
